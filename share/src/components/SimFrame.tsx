...
const SimFrame: React.FC<SimFrameProps> = props => {
    return (
        <div className="game-embed">
            <iframe ref={ref => props.simulator.setFrame(ref)} className="game-embed-frame" title="MakeCode Arcade Simulator" src="http://localhost:3232/--run?fullscreen=1&nofooter=1&id=13415-29846-81435-24572" />
        </div>
    );
}
