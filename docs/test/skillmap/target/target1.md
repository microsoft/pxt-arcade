...
let myBooth = sprites.create(assets.image`booth1`, SpriteKind.Booth)
myBooth.z = 100
info.startCountdownGame(60, winTypes.Score)
forever(function () {
