...
- :paint brush:  We need to make sure to include a block for your player to start the running the default animation again. Otherwise the player disappears! Click **the second** empty grey box in the bundle
