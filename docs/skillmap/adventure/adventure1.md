...
``||loggr:add ["Great Choice..."] to text log||`` <br/>
into the empty<br/>
...
- :align left: From ``||loggr: Text Log||``, drag<br/>
``||loggr:add ["Your adventure..."] to text log||`` <br/>
into the empty<br/>
...
namespace loggr {
    ...
    export function changeLogColors(c1: number, c2: number) {
        loggr.activeColor = c1;
        loggr.readColor = c2;
    }
}
namespace info {
    //% blockId=set_score_override
    //% block="set coins to $thisScore"
    //% thisScore.defl=0
    ...
    //% block="change coins by $thisScore"
    //% thisScore.defl=1
