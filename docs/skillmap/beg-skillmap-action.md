...
* description: Learn to create arcade games quickly using a handful of simple-to-follow tutorials!
* infoUrl: skillmap/educator-info/basic-map-info
* bannerUrl: /static/skillmap/story/story-activity4.png
* backgroundurl: static/skillmap/collector/speckled-field.png  
* primarycolor: #ff7f41
