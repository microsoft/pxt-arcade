...
**Feel like making enemies rain from the sky?**<br/>
👾👾👾  
...
for the enemies using a<br/>
``||Math:pick random [0] to [10]||`` block.<br/>
Connect it to replace the **0** in the<br/>
``||sprites:set [myEnemy] [x] to [0]||``<br/>
block.

- :mouse pointer: Finally, update the minimum argument of the<br/>
...
``||variables:mySprite||`` value inside<br/>
...
Now you have a bunch of enemies to combat.<br/>
