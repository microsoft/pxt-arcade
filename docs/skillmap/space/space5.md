...
- :align justify: Grab<br/>
``||variables:set [enemySpeed] to [0]||``<br/>
...
- :mouse pointer: Go back to the<br/>
...
- :binoculars: Find the<br/>
``||sprites:on [sprite] of kind [Projectile] overlaps [otherSprite] of kind [Enemy]||``<br/> 
container already in your workspace.

- :random: Drag out a<br/>
