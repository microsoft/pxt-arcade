...
<details>
<summary>Show me! 🔎</summary>
![Here's where to look for the workspace](/static/skillmap/turkey/game.gif "The workspace is on the right.")
</details>
...
In games, a sprite is a 2-dimensional object that can move and change. Think of it as a picture that does something…but a sprite is more than just an image.
</details>

---

Let's create a turkey sprite and get it moving. (Keep scrolling to read more.)
...
**Time to get the turkey sprite moving!**
