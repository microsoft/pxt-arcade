...
It is called *frame-based animation*. <br/>
![An example of a flipbook.](/static/courses/csintro/S01.L03.05.P01.flipbook.jpg) <br/>
...
1.   Set your new variable to an array of images.
     1.   Drag a <br/>
     ``||variables:set (frameList) to (0)||`` <br/>
     block into your <br/>
     ...
     space in your array. <br/>
     (The ``||images:Images||`` drawer is in the
     **Advanced** section of the toolbox.)<br/>
...
1.   Add a block to the end of your <br/>
...
1.   Add these blocks to your new container:
     -    Use blocks from the <br/>
     ``||sprites:Sprites||`` and <br/>
...
Try different values in the <br/>
``||game:on game update every (500) ms||`` <br/>
...
**Congratulations! You've manually animated a sprite!**<br/>
🐣 🐥 🐓
...
![Lab 3.4.1](https://arcade.makecode.com/api/_H0zMKtd9Wh6s/thumb)
