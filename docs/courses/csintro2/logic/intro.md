...
> Example: Is laserPower (8) greater than enemyShieldStrength (5)? If it is ``||logic:true||`` that laserPower is greater than enemyShieldStrength, then we will add 1 to numEnemiesDestroyed.
