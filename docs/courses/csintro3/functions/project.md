...
{
    "name": "Star Count",
    "imageUrl": "/static/courses/csintro3/functions/star-count.gif"
}
]
```
...
1. Think of **at least** 3 ideas for games that use some of the "concepts learned" listed above. Your game should include at least 3 functions. At least 2 functions with parameters and at least 1 function with return values. All functions should be commented correctly.
...
### [Teacher Material](/courses/csintro3/about/teachers)
