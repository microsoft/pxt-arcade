...
![An arcade button with a JST cable](/docs/static/hardware/raspberry-pi/cardboard-control-panel/button.jpg)

* Insert 2 male jumper wires into the JST connector.

![A JST connector with 2 female jumper wires attached](/docs/static/hardware/raspberry-pi/cardboard-control-panel/headers.jpg)
...
![Electrical tape to secure the jumper cables](/docs/static/hardware/raspberry-pi/cardboard-control-panel/headerstape.jpg)

* Using the wire stripper, strip one of the female jumper wires (strip off about 1/2" or 1cm).

![A female jumper wire and a stripped jumper wire](/docs/static/hardware/raspberry-pi/cardboard-control-panel/strip.jpg)
...
![All buttons wired and ready](/docs/static/hardware/raspberry-pi/cardboard-control-panel/allwires.jpg)
...
![A bundle of stripped jumper wire cables](/docs/static/hardware/raspberry-pi/cardboard-control-panel/bundle.jpg)
...
![A jumper wire attached to the bundle of jumper wires](/docs/static/hardware/raspberry-pi/cardboard-control-panel/gndwire.jpg)
...
![Connection wires on the joystick terminals](/docs/static/hardware/raspberry-pi/cardboard-control-panel/joystick.jpg)
...
![Joystick cables with jumper wires attached from the JST connectors](/docs/static/hardware/raspberry-pi/cardboard-control-panel/joystickconnectors.jpg)
...
![A small zip tie keep wires together](/docs/static/hardware/raspberry-pi/cardboard-control-panel/joystickzip.jpg)

### ~

* Join the 4 stripped jumper wires into a bundle.

![A bundle of stripped jumper cables from the joystick terminals](/docs/static/hardware/raspberry-pi/cardboard-control-panel/joystickbundle.jpg)
