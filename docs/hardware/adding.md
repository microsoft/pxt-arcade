...
Additionally, we're considering adding the following in the future (but not in the next 6 months):
...
* if using SPI screen, if needs to be on SPI pins (of course); on F4 use SPI1 as it's faster
