...
``||variables(sprites):set [rockscout] to sprite [ ] of kind [Player]||`` <br/>
...
``||controller:move [rockscout] with buttons ⊕||``  <br/>
...
- :tree: To start Terri at the stage door, go to ``||scene:Scene||`` and drag<br/>
``||scene: place [rockscout] on top of random [ ]||``<br/>
...
``||scene:camera follow sprite [rockscout]||``<br/>
to **the end** of the<br/>
...
- :tree: To detect an overlap, go to ``||scene:Scene||`` and drag an<br/>
...
- :tree: To detect an overlap, go to ``||scene:Scene||`` and drag the<br/>
``||scene:on [sprite] of kind [Player] overlaps [ ] at [location]||``<br/>
bundle into an empty area of the workspace.
