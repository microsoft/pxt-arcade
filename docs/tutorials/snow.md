...
```block
    ...
    scenery.top = 5
```
This block places the top of the **scenery** image to 5 pixels below the top edge of the screen.  
...
block and choose one of the placeholder images from the **Gallery**.<br/><br/>
![Choose a Placeholder](/static/tutorials/snow/place.png "The skater, the string of lights, or the squirrel.")


- :mouse pointer: Click the empty grey square inside the <br/>
``||animation(noclick):animate [anim]||`` <br/>
block and choose the animation that looks most like your placeholder image.<br/><br/>
![Choose an Animation](/static/tutorials/snow/anim.png "The skater, the string of lights, or the squirrel.")
...
(You can switch to the **My Assets** tab at the top of the editor to use a song of ours.)
...
sprites.wrap2(function () {
    scenery = sprites.create(img`.`, SpriteKind.Player)
    scenery.top = 5
})
