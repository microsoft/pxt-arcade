...
declare const enum DAL {
    ...
    // built/codal/libraries/codal-core/inc/driver-models/Display.h
    DISPLAY_EVT_RENDER = 3,
    DISPLAY_EVT_RENDER_START = 2,
    DISPLAY_EVT_RENDER_COMPLETE = 4,
